...
public class GemPolishingScreenHandler extends ScreenHandler {
    ...
    public final GemPolishingStationBlockEntity BLOCK_ENTITY;
    ...
    public GemPolishingScreenHandler(int syncId, PlayerInventory playerInventory, BlockEntity blockEntity, PropertyDelegate arrayPropertyDelegate) {
        super(RtScreenHandler.GEM_POLISHING_HANDLER, syncId);
        checkSize(((Inventory) blockEntity), 2);
        this.INVENTORY = ((Inventory) blockEntity);
        playerInventory.onOpen(playerInventory.player);
        this.PROPERTY_DELEGATE = arrayPropertyDelegate;
        this.BLOCK_ENTITY = ((GemPolishingStationBlockEntity) blockEntity);
    ...
    public boolean isCrafting() {
        return PROPERTY_DELEGATE.get(0) > 0;
    }
